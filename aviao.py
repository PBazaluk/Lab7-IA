...
a = img_gray.max()
_, thresh = cv2.threshold(img_gray, 100, a, cv2.THRESH_BINARY_INV)
...
img_erode = cv2.erode(img_dilate1, kernel, iterations=1)
...
# Detecção borda com Canny (com erode)
edges_erode = cv2.Canny(image=img_erode1, threshold1=a/2, threshold2=a/2)
...
# plot imagens
imagens = [img, img_blur, img_gray, thresh, img_dilate, img_dilate1, img_erode,
           img_erode1, final]
